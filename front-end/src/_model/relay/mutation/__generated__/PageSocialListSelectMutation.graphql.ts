...
export type PageSocialListSelectMutationVariables = {
    authToken?: string | null;
    limit: number;
    page: number;
};
export type PageSocialListSelectMutationResponse = {
...
export type PageSocialListSelectMutation = {
    readonly response: PageSocialListSelectMutationResponse;
    readonly variables: PageSocialListSelectMutationVariables;
};



/*
mutation PageSocialListSelectMutation(
  $authToken: String
  $limit: Int!
  $page: Int!
) {
...
const node: ConcreteRequest = (function () {
    ...
    return {
        "fragment": {
            ...
            "kind": "Fragment",
            "metadata": null,
            "name": "PageSocialListSelectMutation",
            "selections": (v1 /*: any*/),
            "type": "Mutation"
        },
        "kind": "Request",
        ...
        "params": {
            ...
            "text": "mutation PageSocialListSelectMutation(\n  $authToken: String\n  $limit: Int!\n  $page: Int!\n) {\n  getPageSocialList(authToken: $authToken, limit: $limit, page: $page) {\n    token\n    pageSocialCount\n    pageSocialList {\n      id\n      internalId\n      name\n      publisherPlatform {\n        idPublisherPlatform\n        valuePublisherPlatform\n      }\n      numAds\n    }\n  }\n}\n"
        }
    } as any;
})();
(node as any).hash = '5cf779affb6fd3b4e5e928e8a5b09da3';
export default node;
